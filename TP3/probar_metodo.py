...
CASOS = [
    ...
    ("F8", f8, 2.0, 3.0, 1e-8),
    ("F9", f9, 1.0, 1.5, 1e-8),
    ("F10", f10, 4.5, 5.2, 1e-8),
    ("F11", f11, 2.0, 3.5, 1e-8),
    ("F12", f12, 1.0, 4.0, 1e-8),
    ("F13", f13, 0.4, 0.8, 1e-8),
    ("F14", f14, 1.8, 2.3, 1e-8),
    ("F15", f15, 0.2, 0.6, 1e-8),
    ("F16", f16, -10000.0, 10000.0, 1e-8),
    ("F17", f17, -200000.0, 200000.0, 1e-8),
]
